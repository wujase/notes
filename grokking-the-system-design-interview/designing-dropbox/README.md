...
![High-level Design of Dropbox](high-level-design-of-dropbox.svg)
...
![Message Queuing Service](message-queuing-service.svg)
...
![Detailed Component Design of Dropbox](detailed-component-design-of-dropbox.svg)
...
When the cache is full, and we want to replace a chunk with a newer/hotter chunk, how would we choose? Least Recently Used (LRU) can be a reasonable policy for our system. Under this policy, we discard the least recently used chunk first. Similarly, we can have a cache for Metadata DB.
